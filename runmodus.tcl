...
build_model \
    -cell	 fifo_sync \
    -techlib	 ../lib/slow.v \
    -designsource	 $WORKDIR/fifo_sync.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/fifo_sync.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 fifo_sync_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_fifo_sync_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 fifo_sync_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_fifo_sync_atpg
...
check_log log_commit_tests_FULLSCAN_fifo_sync_atpg
